  ...
  return (
    <section className="contain-outer section">
      ...
      <a
        ...
        className="mb-6 inline-flex items-center gap-2 text-lg font-medium text-gray-600 transition-colors hover:text-pink-600 hover:underline"
      >
        <svg
          className="h-5 w-5"
          fill="currentColor"
